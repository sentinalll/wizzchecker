...
public class ReturnBundle {
    ...
    public ReturnBundle withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ReturnBundle withAncillaryServices(List<String> ancillaryServices) {
        this.ancillaryServices = ancillaryServices;
        return this;
    }
    ...
    public ReturnBundle withFareLockFeeCode(String fareLockFeeCode) {
        this.fareLockFeeCode = fareLockFeeCode;
        return this;
    }
    ...
    public ReturnBundle withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
