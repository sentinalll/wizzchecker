...
public class ReturnFlight {
    ...
    public ReturnFlight withDepartureStation(String departureStation) {
        this.departureStation = departureStation;
        return this;
    }
    ...
    public ReturnFlight withArrivalStation(String arrivalStation) {
        this.arrivalStation = arrivalStation;
        return this;
    }
    ...
    public ReturnFlight withCarrierCode(String carrierCode) {
        this.carrierCode = carrierCode;
        return this;
    }
    ...
    public ReturnFlight withFlightNumber(String flightNumber) {
        this.flightNumber = flightNumber;
        return this;
    }
    ...
    public ReturnFlight withFlightSellKey(String flightSellKey) {
        this.flightSellKey = flightSellKey;
        return this;
    }
    ...
    public ReturnFlight withDepartureDateTime(String departureDateTime) {
        this.departureDateTime = departureDateTime;
        return this;
    }
    ...
    public ReturnFlight withArrivalDateTime(String arrivalDateTime) {
        this.arrivalDateTime = arrivalDateTime;
        return this;
    }
    ...
    public ReturnFlight withFares(List<Fare> fares) {
        this.fares = fares;
        return this;
    }
    ...
    public ReturnFlight withInfantLimitExceeded(InfantLimitExceeded infantLimitExceeded) {
        this.infantLimitExceeded = infantLimitExceeded;
        return this;
    }
    ...
    public ReturnFlight withWheelchairLimitExceeded(WheelchairLimitExceeded wheelchairLimitExceeded) {
        this.wheelchairLimitExceeded = wheelchairLimitExceeded;
        return this;
    }
    ...
    public ReturnFlight withOxyLimitExceeded(OxyLimitExceeded oxyLimitExceeded) {
        this.oxyLimitExceeded = oxyLimitExceeded;
        return this;
    }
    ...
    public ReturnFlight withSportsEquipmentLimitExceeded(SportsEquipmentLimitExceeded sportsEquipmentLimitExceeded) {
        this.sportsEquipmentLimitExceeded = sportsEquipmentLimitExceeded;
        return this;
    }
    ...
    public ReturnFlight withIsRequest(boolean isRequest) {
        this.isRequest = isRequest;
        return this;
    }
    ...
    public ReturnFlight withPie(boolean pie) {
        this.pie = pie;
        return this;
    }
    ...
    public ReturnFlight withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
